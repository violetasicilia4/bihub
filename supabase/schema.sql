...
insert into public.dashboards (id, name, vertical, description, url, update_frequency, metrics, tags, last_updated, views_count)
select * from (values
  ('retencion-001', 'Riesgo de fuga clientes', 'Retención', 'Identifica clientes con señales tempranas de abandono y permite monitorear la efectividad de las acciones de retención automatizadas.', 'https://app.powerbi.com/view?r=eyJRIjoiaHR0cHM6Ly9hcHAucG93ZXJiaS5jb20iLCJUaWQiOiJmYWtlX3RlbWFudCJ9', 'Diaria', array['Churn','Actividad','Segmento','Campañas'], array['clientes','fuga','retención','churn','prevención'], 'Hace 4 horas', 342),
  ('adquisicion-001', 'Altas por canal', 'Adquisición', 'Permite analizar altas, canales de origen (SEO, SEM, Referidos) y la evolución de captación neta por período.', 'https://app.powerbi.com/view?r=eyJSZXN1bWVuIjpIYWx0YXNDYW5hbCJ9', 'Semanal', array['Altas','Canal','Conversión','CAC'], array['altas','canales','captación','performance'], 'Ayer, 18:30', 512),
  ('desarrollo-001', 'Performance de cartera', 'Desarrollo', 'Monitorea la evolución de cuentas activas, performance mensual de facturación y oportunidades de crecimiento de up-selling.', 'https://app.powerbi.com/view?r=eyJDYXJ0ZXJhIjpQZXJmb3JtYW5jZSJ9', 'Mensual', array['Cartera','Performance','Evolución','Objetivos'], array['cartera','crecimiento','performance','ventas','mensual'], 'Hace 3 días', 189),
  ('cross-001', 'Resumen ejecutivo', 'Cross equipo', 'Vista transversal de alta dirección con indicadores clave agregados (KPIs de negocio, satisfacción general y EBITDA).', 'https://app.powerbi.com/view?r=eypFeGVjdXRpdmUiOiJSZXN1bWVuIn0=', 'Diaria', array['KPIs','Clientes','Evolución','Negocio'], array['ejecutivo','cross','kpis','general','directorio'], 'Hace 2 horas', 1205),
  ('retencion-002', 'LTV y Cohortes de Churn', 'Retención', 'Análisis de tiempo de vida del cliente (Lifetime Value) segmentado por cohorte mensual de registro y tipo de suscripción.', 'https://app.powerbi.com/view?r=eyJMVEZDb2hvcnRlcyI6IlJldGVuY2lvbiJ9', 'Semanal', array['LTV','Cohortes','Permanencia','Suscripción'], array['clientes','cohortes','ltv','retención','finanzas'], 'Hace 1 día', 267),
  ('adquisicion-002', 'Embudo de conversión Web', 'Adquisición', 'Monitoreo del tráfico del sitio web, tasa de conversión por etapa del embudo y puntos de fuga en el flujo de registro.', 'https://app.powerbi.com/view?r=eyJFbWJ1ZG8iOiJDb252ZXJzaW9uIn0=', 'Diaria', array['Tráfico','Conversión','Fuga','Signups'], array['web','conversión','campañas','embudo','analytics'], 'Hace 1 hora', 489),
  ('adquisicion-003', 'Performance de Campañas Paid', 'Adquisición', 'Métricas consolidadas de inversión publicitaria en Google Ads, Meta Ads y LinkedIn Ads versus retorno de inversión (ROAS).', 'https://app.powerbi.com/view?r=eyJDYW1wYWduYXMiOiJQYWlkIn0=', 'Diaria', array['Inversión','ROAS','CPA','Clicks'], array['campañas','paid','google','meta','performance','inversión'], 'Hace 30 mins', 610),
  ('desarrollo-002', 'Evolución de ARPU mensual', 'Desarrollo', 'Evolución del ingreso promedio por usuario (ARPU) clasificado por industria, segmento comercial y plan contratado.', 'https://app.powerbi.com/view?r=eyJBUlBVIjpFdm9sdWNpb24ifQ==', 'Mensual', array['ARPU','Ingresos','Segmento','Planes'], array['arpu','ingresos','mensual','desarrollo','rentabilidad'], 'Hace 5 días', 142),
  ('desarrollo-003', 'Performance Ventas Latam', 'Desarrollo', 'Desempeño del equipo comercial regional, porcentaje de cumplimiento de cuotas de ventas individuales y pipeline de negocios.', 'https://app.powerbi.com/view?r=eyJMYXRhbSI6IlZlbnRhcyJ9', 'Diaria', array['Ventas','Pipeline','Cuotas','Vendedores'], array['ventas','latam','desarrollo','performance','comercial'], 'Ayer, 09:00', 304),
  ('cross-002', 'NPS y Satisfacción de Cliente', 'Cross equipo', 'Consolidado de encuestas NPS mensuales, CSAT de soporte y principales temáticas de reclamo categorizadas por IA.', 'https://app.powerbi.com/view?r=eyJOUFMiOiJTYXRpc2ZhY2Npb24ifQ==', 'Semanal', array['NPS','CSAT','Soporte','Fidelidad'], array['clientes','nps','satisfacción','soporte','cross'], 'Hace 2 días', 422),
  ('cross-003', 'Uso y Adopción de Plataforma', 'Cross equipo', 'Métricas de adopción de funcionalidades clave del software, usuarios activos diarios/mensuales (DAU/MAU) y stickiness.', 'https://app.powerbi.com/view?r=eyJBY29wY2lvbiI6IlBsYXRhZm9ybWEifQ==', 'Diaria', array['DAU','MAU','Engagement','Features'], array['producto','adopción','stickiness','usuarios','cross'], 'Hace 12 horas', 730),
  ('retencion-003', 'Salud de Cuenta & Alertas Early', 'Retención', 'Sistema de scoring de salud de clientes B2B que alerta proactivamente sobre cuentas en riesgo según inactividad prolongada.', 'https://app.powerbi.com/view?r=eyJTYWx1ZCI6IkFsdWVydGFzIn0=', 'Tiempo Real', array['Health Score','Alertas','Interacción','Riesgo'], array['alertas','salud','b2b','retención','tiempo real'], 'En tiempo real', 524),
  ('cross-004', 'Costos de Infraestructura Cloud', 'Cross equipo', 'Consumo consolidado de servidores, bases de datos e infraestructura GCP, AWS y Azure con proyección de presupuestos anuales.', 'https://app.powerbi.com/view?r=eyJDb3N0b3MiOiJJbmZyYWEifQ==', 'Mensual', array['Costos Cloud','Presupuesto','Servidores','FinOps'], array['costos','cloud','infraestructura','finops','devops'], 'Hace 1 mes', 95)
) as seed(id, name, vertical, description, url, update_frequency, metrics, tags, last_updated, views_count)
